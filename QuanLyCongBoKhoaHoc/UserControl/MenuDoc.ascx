        ...
        <ul class="list-group2">
            ...
            <li class="list-group-item category-item category-item-before ">
                <a href="#">
                    ...
                    <div class="category-info">
                        <p class="titleCT">Công Bố Khoa học</p>
                        <p class="infoCT">Công bố khoa học mới nhất</p>
                    </div>
                </a>
            </li>
            <li class="list-group-item category-item">
                <a href="">
                    ...
                    <div class="category-info">
                        ...
                        <p class="infoCT">Các bài báo khoa học nổi bật</p>
                    </div>
                </a>
            </li>
            <li class="list-group-item category-item">
                <a href="">
                    ...
                    <div class="category-info">
                        ...
                        <p class="infoCT">Sách khoa học mới</p>
                    </div>
                </a>
            </li>
            <li class="list-group-item category-item">
                <a href="">
                    ...
                    <div class="category-info">
                        <p class="titleCT">Giáo Trình Khoa Học</p>
                        <p class="infoCT">Giáo trình khoa học mới</p>
                    </div>
                </a>
            </li>
            <li class="list-group-item category-item">
