        ...
        void LoadUcControl()
        {
            ...
            else
            {
                ...
                switch (UC)
                {
                    ...
                    // đề tài sau đại học
                    case "DTSDH":
                        PlaceHolder1.Controls.Add(LoadControl("~/Admin/AdUserControl/AdUcDeTaiSauDaiHoc.ascx"));
                        break;
                    // học viên sau đại học
                    case "HVSDH":
                        PlaceHolder1.Controls.Add(LoadControl("~/Admin/AdUcHocVienSauDaiHoc/.ascx"));
                        break;
                    // học viên và đề tài sau đại học
                    case "HVVDTSDH":
                        PlaceHolder1.Controls.Add(LoadControl("~/Admin/AdUserControl/AdUcHocVienVaDeTaiSauDaiHoc.ascx"));
                        break;
