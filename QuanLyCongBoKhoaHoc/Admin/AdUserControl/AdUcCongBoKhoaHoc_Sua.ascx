...
<div class="form-group">
    <label class="col-sm-2 col-lg-2 control-label"><b> Năm công bố : </b> </label>
    <div class="col-sm-9 col-lg-9 controls">
        <input class="form-control" type="text" runat="server" id="txtNamCongBo" value="" placeholder="Nhập năm công bố khoa học">
