    ...
    <div class="col-lg-12">
        <div class="box">
            ...
            <div class="box-content">             
                <br />
                    <form class="form-horizontal" role="form">
                         <div class="form-group">
                                 <label for="inputEmail3" class="col-lg-2 control-label col-md-offset-2"> <b> Nhập họ tên hoặc email liên hệ cần tìm: </b> </label>
                            <div class="col-lg-5">
                ...
                <asp:GridView ID="grvLienHe" runat="server" EnableViewState="False" CssClass="table table-bordered table-hover" AutoGenerateColumns="False" 
                  DataKeyNames="MaLienHe" OnRowCommand="grvLienHe_RowCommand" OnRowDeleting="grvLienHe_RowDeleting"  >
                    <Columns>
                         <asp:TemplateField>
                                     <HeaderTemplate>
