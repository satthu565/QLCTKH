...
<div class="">
    <div class="table-responsive">
        <asp:GridView ID="gvCongBoKhoaHoc" runat="server" AllowPaging="True" PageSize="15" CssClass="table table-bordered table-hover" AutoGenerateColumns="False"
           DataKeyNames="MaCongTrinhKhoaHoc" ShowHeaderWhenEmpty="True" OnRowCommand="gvCongBoKhoaHoc_RowCommand"  >
            <Columns>
                <asp:TemplateField>
                    <HeaderTemplate>
              ...
              <asp:BoundField DataField="MaSo" HeaderText="Ma So" ReadOnly="True"  SortExpression="MaSo" ItemStyle-CssClass="col-lg-1" ItemStyle-HorizontalAlign="Center">
                    <ItemStyle HorizontalAlign="Center" CssClass="col-lg-1"></ItemStyle>
                </asp:BoundField>
                <asp:BoundField DataField="TenCongTrinh" HeaderText="Ten Cong Trinh"
                    SortExpression="TenCongTrinh" />
                <asp:BoundField DataField="NamCongBo" DataFormatString="{0:dd/MM/yyyy}"
                    HeaderText="Nam Cong Bo" SortExpression="NamCongBo" />
